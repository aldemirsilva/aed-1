...
/* Calcula o produto interno entre dois vetores, retornando o resultado */
...
int main() {
  ...
  /* Novo tipo de comando de repeticão ( do { ...} while (condicao); diferenca
   * pro while é que sempre executa a 1a vez
   */
